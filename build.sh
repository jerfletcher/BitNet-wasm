...
EMCC_FLAGS="-O2 -s WASM=1 -s MODULARIZE=1 -s EXPORT_ES6=1 -s EXPORTED_RUNTIME_METHODS=['ccall','cwrap','HEAPU8','HEAPF32','HEAP8','HEAP32'] -s EXPORTED_FUNCTIONS=['_ggml_init','_ggml_nelements','_ggml_bitnet_init','_ggml_bitnet_free','_ggml_bitnet_mul_mat_task_compute','_ggml_bitnet_transform_tensor','_bitnet_wasm_infer','_gguf_to_flat','_malloc','_free'] -s ALLOW_MEMORY_GROWTH=1"
